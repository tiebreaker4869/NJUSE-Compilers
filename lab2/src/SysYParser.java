// Generated from /home/steven/Desktop/coding/compilers/Lab/src/SysYParser.g4 by ANTLR 4.10.1
...
public class SysYParser extends Parser {
	...
	public static final int
		...
		SEMICOLON=33, IDENT=34, INTEGR_CONST=35, WS=36, LINE_COMMENT=37, MULTILINE_COMMENT=38;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"INTEGR_CONST", "WS", "LINE_COMMENT", "MULTILINE_COMMENT"
		};
	}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << CONST) | (1L << INT) | (1L << FLOAT) | (1L << IF) | (1L << WHILE) | (1L << BREAK) | (1L << CONTINUE) | (1L << RETURN) | (1L << PLUS) | (1L << MINUS) | (1L << NOT) | (1L << L_PAREN) | (1L << L_BRACE) | (1L << SEMICOLON) | (1L << IDENT) | (1L << INTEGR_CONST))) != 0)) {
				{
				{
				setState(191);
				blockItem();
