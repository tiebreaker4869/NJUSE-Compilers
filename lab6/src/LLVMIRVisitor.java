...
public class LLVMIRVisitor extends SysYParserBaseVisitor<LLVMValueRef> {
    ...
    public LLVMValueRef visitIfStmt(SysYParser.IfStmtContext ctx) {
        ...
        condValue = LLVMBuildZExt(builder, condValue, i32Type, "");
        condValue = LLVMBuildICmp(builder, LLVMIntNE, condValue, zero, "");
    ...
    public LLVMValueRef visitCompareExp(SysYParser.CompareExpContext ctx) {
        ...
        if (ctx.GT() != null) {
            return LLVMBuildICmp(builder, LLVMIntSGT, LLVMBuildZExt(builder, visit(ctx.cond(0)), i32Type, ""), LLVMBuildZExt(builder, visit(ctx.cond(1)), i32Type, ""), "");
        }

        if (ctx.GE() != null) {
            return LLVMBuildICmp(builder, LLVMIntSGE,  LLVMBuildZExt(builder, visit(ctx.cond(0)), i32Type, ""), LLVMBuildZExt(builder, visit(ctx.cond(1)), i32Type, ""), "");
        }

        if (ctx.LT() != null) {
            return LLVMBuildICmp(builder, LLVMIntSLT,  LLVMBuildZExt(builder, visit(ctx.cond(0)), i32Type, ""), LLVMBuildZExt(builder, visit(ctx.cond(1)), i32Type, ""), "");
        }

        if (ctx.LE() != null) {
            return LLVMBuildICmp(builder, LLVMIntSLE,  LLVMBuildZExt(builder, visit(ctx.cond(0)), i32Type, ""), LLVMBuildZExt(builder, visit(ctx.cond(1)), i32Type, ""), "");
        }
    ...
    public LLVMValueRef visitRelationExp(SysYParser.RelationExpContext ctx) {
        if (ctx.EQ() != null) {
            return LLVMBuildICmp(builder, LLVMIntEQ,  visit(ctx.cond(0)), visit(ctx.cond(1)), "");
        }

        return LLVMBuildICmp(builder, LLVMIntNE, visit(ctx.cond(0)), visit(ctx.cond(1)), "");
    }
    ...
    public LLVMValueRef visitAndExp(SysYParser.AndExpContext ctx) {
        return LLVMBuildAnd(builder, LLVMBuildZExt(builder, visit(ctx.cond(0)), i32Type, ""), LLVMBuildZExt(builder, visit(ctx.cond(1)), i32Type, ""), "");
    }

    @Override
    public LLVMValueRef visitOrExp(SysYParser.OrExpContext ctx) {
        return LLVMBuildOr(builder,  LLVMBuildZExt(builder, visit(ctx.cond(0)), i32Type, ""), LLVMBuildZExt(builder, visit(ctx.cond(1)), i32Type, ""), "");
    }
